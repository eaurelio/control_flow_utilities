/**
 * A função curry converte uma determinada função em uma versão curry.
 * Currying é uma técnica na qual uma função que recebe vários argumentos é transformada em uma sequência de funções, cada uma recebendo um único argumento.
*/
